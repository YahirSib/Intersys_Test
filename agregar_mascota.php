...
<body id="body-pd">
    ...
    ?>
    <div class="p-6">
    <h1 class="text-5xl font-extrabold dark:text-white" >Añadir nueva mascota</h1>
    <form class="grid md:grid-rows-2 gap-6" id="frmAgregar" enctype="multipart/form-data">
...
<script src="controlador/agregar_mascota.js"></script>
</body>
</html>
